...
class _AllState extends State<All> {
  ...
  void initState() {
    ...
    fetchRestaurants(widget.region , email);
  }
  ...
  Future<void> fetchRestaurants(String region , String email) async {

    var response = await http.get(Uri.parse(
        "http://192.168.56.1/damproject/getRestaurantsR.php?region=$region&email=$email"));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                /* IconButton(
                                  icon: Icon(
                                    restaurant['liked']==1 ? Icons.favorite : Icons.favorite_border_rounded,
                                    color: Colors.black,
                                  ),
                                  onPressed: () =>
